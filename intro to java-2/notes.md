...
- Runs directly on hardware with *no interpreter* or *runtime engine*
...
The final execution is **native machine code**, but produced *at runtime*, not compile-time.
...
- Results in *better-than-C performance sometimes* (true in HotSpot)
